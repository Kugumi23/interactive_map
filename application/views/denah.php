    ...
    <script>
        ...
        <?php foreach($marker as $m): ?>
            ...
            marker.on('click', function () {
                ...
                if (match.length > 0) {
                    ...
                    collapse.innerHTML = `
                        <div class="container d-flex">
                            <h4 class="p-2 text-center">Informasi Lokasi</h4>
                        ...
                        <p><i class="bi bi-map-fill me-2 ms-2"></i><?php echo $m->latitude . ' , ' . $m->longitude ?></p>`;

                        let carouselEl = document.getElementById('image');
                        if (carouselEl) {
                ...
                // Kondisi untuk menampilkan collapse
